...
const DEFAULT_MANIFEST = "data/admissions/runtime-core-lite-v3333-manifest.json";
const EXPECTED_VERSION = "local-deterministic-v3.333-beijing-official-undergraduate-rank2025-national-bonus-municipal-local-bonus-guard-868426records";
...
const audit = {
  dataset: "runtime-core-lite-v3333",
