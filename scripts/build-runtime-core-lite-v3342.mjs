...
const defaultManifest = "data/admissions/runtime-core-lite-v3342-manifest.json";
const expectedVersion = "local-deterministic-v3.342-typography-safe-admission-options-868426records";
...
if (projectRoot.startsWith("/Volumes/")) throw new Error("Refusing external-volume processing; run from internal APFS staging.");
...
if (fullCore.modelVersion !== expectedVersion) throw new Error(`Unexpected model version ${fullCore.modelVersion}`);
...
const audit = {
  dataset: "runtime-core-lite-v3342",
