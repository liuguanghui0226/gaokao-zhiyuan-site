...
const audit = JSON.parse(fs.readFileSync(path.join(root, "data/admissions/runtime-core-lite-v3332-manifest.json")));
...
assert.ok(lite.browserRuntime.sourceNoteFields.includes("lowerAggregateEstimateGuard"));
