...
assert.equal(manifest.version, "v3.367");
assert.equal(manifest.applicationPlanReadiness.currentYear, 2026);
assert.equal(manifest.applicationPlanReadiness.currentPlanConfirmedGroups, 4523);
assert.equal(manifest.applicationPlanReadiness.currentPlanCoverageRate, 0.011614);
...
assert.match(html, /2026计划已佐证 4,523 \/ 389,435/);
