...
const outFile = path.join(projectRoot, "data/admissions/official-control-line-coverage-2026-v3285.json");
const expectedCovered = ["安徽", "广东", "河南", "湖南", "江西", "吉林", "陕西", "山东", "四川", "新疆", "西藏", "浙江"];
...
assert(coveredProvinces.length === 12 && missingProvinces.length === 19, "Expected 12 covered and 19 missing provinces after Anhui v3.285");

const report = {
  dataset: "official-control-line-coverage-2026-v3285",
  generatedAt: core.generatedAt,
  modelVersion: core.modelVersion,
  definition: "运行分片中2026年普通类本科/专科或普通类一段/二段省级控制线；特殊类型、艺体、军警、专项、定向、预科、少数民族和对口路径不计入。",
