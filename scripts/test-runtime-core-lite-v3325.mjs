...
const auditFile = path.join(projectRoot, "data/admissions/runtime-core-lite-v3325-manifest.json");
...
assert.equal(lite.modelVersion, "local-deterministic-v3.325-hainan-official-rank2025-policy-bonus-inclusive-published-floor-aligned-868426records");
...
assert.equal(liteNotes.length, 5129);
...
assert.equal(manifest.coreLite.sourceNotes, 5129);
assert.equal(manifest.runtimeProfile.version, "v3.325");
assert.equal(audit.dataset, "runtime-core-lite-v3325");
