...
assert.ok(html.includes("app.js?v=3.346.27"), "v3.346 asset version missing");
assert.ok(html.includes('data-view="sources" aria-controls="view-sources">数据来源'), "public source navigation missing");
