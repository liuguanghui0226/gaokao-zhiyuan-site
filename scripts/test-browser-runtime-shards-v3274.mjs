...
assert.equal(core.modelVersion, "local-deterministic-v3.333-beijing-official-undergraduate-rank2025-national-bonus-municipal-local-bonus-guard-868426records");
...
assert.equal(fujianEntry.rankConversions, 1859);
...
assert.equal(hebeiEntry.rankConversions, 2181);
...
assert.equal(anhuiEntry.rankConversions, 1937);
...
assert.equal(hunanEntry.rankConversions, 2276);
