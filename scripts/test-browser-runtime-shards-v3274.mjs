...
assert.equal(core.modelVersion, "local-deterministic-v3.307-national-school-official-jxust2023-2025-native-rank-855003records");
...
assert.equal(manifest.shards["北京"].records, 6550);
...
assert.equal(manifest.shards["天津"].records, 9816);
...
assert.equal(manifest.shards["上海"].records, 6098);
...
assert.equal(neimengguEntry.records, 15486);
...
assert.equal(fujianEntry.records, 21819);
...
assert.equal(hebeiEntry.records, 68927);
...
assert.equal(xizangEntry.records, 28324);
...
assert.equal(anhuiEntry.records, 15786);
...
assert.equal(jiangxiEntry.records, 13702);
...
assert.equal(hunanEntry.records, 32249);
...
assert.equal(guangdongEntry.records, 17999);
...
assert.equal(zhejiangEntry.records, 111227);
