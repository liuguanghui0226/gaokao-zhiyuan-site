...
assert.equal(core.modelVersion, "local-deterministic-v3.306-national-school-official-nchu2021-2025-derived-rank-852098records");
...
assert.equal(manifest.shards["北京"].records, 6532);
...
assert.equal(manifest.shards["天津"].records, 9776);
...
assert.equal(manifest.shards["上海"].records, 6051);
...
assert.equal(neimengguEntry.records, 15427);
...
assert.equal(fujianEntry.records, 21699);
...
assert.equal(hebeiEntry.records, 68780);
...
assert.equal(anhuiEntry.records, 15645);
...
assert.equal(jiangxiEntry.records, 13374);
...
assert.equal(hunanEntry.records, 32159);
...
assert.equal(guangdongEntry.records, 17846);
...
assert.equal(zhejiangEntry.records, 111111);
