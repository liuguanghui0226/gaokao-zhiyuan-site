...
const RECORD_FIELDS = [
  ...
  "controlLine", "minScore", "averageScore", "maxScore", "minScoreDifference", "averageScoreDifference", "maxScoreDifference",
  "maxScoreRank", "minRank", "minRankStart",
  ...
  "admissionType", "admissionSubtype", "schoolOfficialScope", "sourceTableTitle", "sourceFirstChoice",
  ...
  "sourceAdmissionTypeRaw", "sourceMajorGroupRaw", "sourceMaxRankRaw", "sourcePlanTypeRaw", "sourceBatchRaw", "sourceRemark",
