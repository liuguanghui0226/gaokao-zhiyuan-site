...
assert.ok(index.includes("./assets/app.js?v=3.326.0"));

console.log(JSON.stringify({ ok: true, plainLanguage: true, clickableDisciplineTiles: true, minimumExplicitTextSizePx: 14, assetVersion: "3.326.0" }, null, 2));
