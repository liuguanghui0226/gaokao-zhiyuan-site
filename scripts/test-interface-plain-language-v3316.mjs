...
assert.ok(index.includes("./assets/app.js?v=3.346.15"));
...
console.log(JSON.stringify({ ok: true, plainLanguage: true, clickableDisciplineTiles: true, minimumExplicitTextSizePx: 14, assetVersion: "3.346.15" }, null, 2));
