...
assert.ok(index.includes("./assets/app.js?v=3.316.0"));

console.log(JSON.stringify({ ok: true, plainLanguage: true, clickableDisciplineTiles: true, minimumExplicitTextSizePx: 14, assetVersion: "3.316.0" }, null, 2));
