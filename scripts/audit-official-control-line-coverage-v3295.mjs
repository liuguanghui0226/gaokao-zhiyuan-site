...
const outFile = path.join(projectRoot, "data/admissions/official-control-line-coverage-2026-v3295.json");
const expectedCovered = ["安徽", "北京", "重庆", "福建", "甘肃", "广东", "广西", "河北", "河南", "湖北", "湖南", "江西", "吉林", "内蒙古", "陕西", "山东", "上海", "四川", "天津", "新疆", "西藏", "浙江"];
...
assert(coveredProvinces.length === 22 && missingProvinces.length === 9, "Expected 22 covered and 9 missing provinces after Guangxi v3.295");
...
const report = {
  dataset: "official-control-line-coverage-2026-v3295",
