...
assert.equal(sourceNote.derivedRankRecords, 77);
assert.equal(sourceNote.rankUnavailableRecords, 7386);
...
assert.match(sourceNote.rankAlignmentBoundary, /河北2025年28条、重庆2025年23条、辽宁2025年26条/);
...
assert.equal(rankUnavailable, 7386);
assert.equal(derived, 77);
