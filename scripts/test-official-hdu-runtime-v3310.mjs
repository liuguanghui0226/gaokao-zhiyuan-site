...
assert.equal(sourceNote.derivedRankRecords, 238);
assert.equal(sourceNote.rankUnavailableRecords, 7225);
...
assert.equal(rankUnavailable, 7225);
assert.equal(derived, 238);
