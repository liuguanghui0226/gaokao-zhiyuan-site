...
assert.equal(sourceNote.derivedRankRecords, 116);
assert.equal(sourceNote.rankUnavailableRecords, 7347);
...
assert.match(sourceNote.rankAlignmentBoundary, /河北2025年28条、重庆2025年23条、辽宁2025年26条、湖南2025年22条、江苏2025年17条/);
assert.match(sourceNote.rankAlignmentBoundary, /江苏仅覆盖第一阶段历史类482分及以上、物理类463分及以上/);
...
assert.equal(rankUnavailable, 7347);
assert.equal(derived, 116);
