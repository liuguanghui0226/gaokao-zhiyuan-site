...
assert.equal(sourceNote.derivedRankRecords, 153);
assert.equal(sourceNote.rankUnavailableRecords, 7310);
...
assert.match(sourceNote.rankAlignmentBoundary, /河北2025年28条、重庆2025年23条、辽宁2025年26条、湖南2025年22条、江苏2025年17条、广西2025年18条、山西2025年19条/);
...
assert.equal(rankUnavailable, 7310);
assert.equal(derived, 153);
