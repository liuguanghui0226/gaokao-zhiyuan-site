...
assert.equal(sourceNote.derivedRankRecords, 175);
assert.equal(sourceNote.rankUnavailableRecords, 7288);
...
assert.match(sourceNote.rankAlignmentBoundary, /河北2025年28条、重庆2025年23条、辽宁2025年26条、湖南2025年22条、江苏2025年17条、广西2025年18条、山西2025年19条、湖北2025年22条/);
...
assert.equal(rankUnavailable, 7288);
assert.equal(derived, 175);
