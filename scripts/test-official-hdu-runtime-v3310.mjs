...
assert.equal(sourceNote.derivedRankRecords, 99);
assert.equal(sourceNote.rankUnavailableRecords, 7364);
...
assert.match(sourceNote.rankAlignmentBoundary, /河北2025年28条、重庆2025年23条、辽宁2025年26条、湖南2025年22条/);
...
assert.equal(rankUnavailable, 7364);
assert.equal(derived, 99);
