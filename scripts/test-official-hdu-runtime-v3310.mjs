...
assert.equal(sourceNote.derivedRankRecords, 297);
assert.equal(sourceNote.rankUnavailableRecords, 7166);
...
assert.equal(rankUnavailable, 7166);
assert.equal(derived, 297);
