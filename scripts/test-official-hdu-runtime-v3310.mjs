...
assert.equal(sourceNote.derivedRankRecords, 273);
assert.equal(sourceNote.rankUnavailableRecords, 7190);
...
assert.match(sourceNote.rankAlignmentBoundary, /河北2025年28条、重庆2025年23条、辽宁2025年26条、湖南2025年22条、江苏2025年17条、广西2025年18条、山西2025年19条、湖北2025年22条、福建2025年24条、黑龙江2025年15条、海南2025年8条、天津2025年16条、上海2025年10条、安徽2025年25条/);
...
assert.match(sourceNote.rankAlignmentBoundary, /安徽按历史\/物理分别使用含加分且公开至200分的完整分档表/);
...
assert.equal(rankUnavailable, 7190);
assert.equal(derived, 273);
