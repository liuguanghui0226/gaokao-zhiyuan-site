...
assert.equal(sourceNote.derivedRankRecords, 28);
assert.equal(sourceNote.rankUnavailableRecords, 7435);
assert.equal(sourceNote.hebei2025ScoreDerivedRankRecords, 28);
assert.match(sourceNote.rankAlignmentBoundary, /仅河北2025年28条/);
...
assert.equal(rankUnavailable, 7435);
assert.equal(derived, 28);
