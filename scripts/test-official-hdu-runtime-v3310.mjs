...
assert.equal(sourceNote.derivedRankRecords, 214);
assert.equal(sourceNote.rankUnavailableRecords, 7249);
...
assert.match(sourceNote.rankAlignmentBoundary, /河北2025年28条、重庆2025年23条、辽宁2025年26条、湖南2025年22条、江苏2025年17条、广西2025年18条、山西2025年19条、湖北2025年22条、福建2025年24条、黑龙江2025年15条/);
...
assert.equal(rankUnavailable, 7249);
assert.equal(derived, 214);
