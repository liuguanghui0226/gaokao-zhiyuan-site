...
assert.equal(sourceNote.derivedRankRecords, 321);
assert.equal(sourceNote.rankUnavailableRecords, 7142);
...
assert.equal(rankUnavailable, 7142);
assert.equal(derived, 321);
