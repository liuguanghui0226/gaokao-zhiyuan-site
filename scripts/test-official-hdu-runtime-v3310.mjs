...
assert.equal(sourceNote.derivedRankRecords, 51);
assert.equal(sourceNote.rankUnavailableRecords, 7412);
...
assert.match(sourceNote.rankAlignmentBoundary, /河北2025年28条、重庆2025年23条/);
...
assert.equal(rankUnavailable, 7412);
assert.equal(derived, 51);
