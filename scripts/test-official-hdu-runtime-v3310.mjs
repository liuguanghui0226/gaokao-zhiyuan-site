...
assert.equal(sourceNote.derivedRankRecords, 134);
assert.equal(sourceNote.rankUnavailableRecords, 7329);
...
assert.match(sourceNote.rankAlignmentBoundary, /河北2025年28条、重庆2025年23条、辽宁2025年26条、湖南2025年22条、江苏2025年17条、广西2025年18条/);
...
assert.equal(rankUnavailable, 7329);
assert.equal(derived, 134);
