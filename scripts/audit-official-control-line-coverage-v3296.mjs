...
const outFile = path.join(projectRoot, "data/admissions/official-control-line-coverage-2026-v3296.json");
const expectedCovered = ["安徽", "北京", "重庆", "福建", "甘肃", "广东", "广西", "贵州", "河北", "河南", "湖北", "湖南", "江西", "吉林", "内蒙古", "陕西", "山东", "上海", "四川", "天津", "新疆", "西藏", "浙江"];
...
assert(manifest.modelVersion === "local-deterministic-v3.296-guizhou-control-lines2026-and-rank-provenance-847019records", "Unexpected v3.296 model version");
assert(manifest.recordCount === 847019, "Unexpected v3.296 record count");
assert(core.admissionScoreLayer.coverage.dataTypes["control-line"] === 1373, "Unexpected v3.296 control-line count");
const coverage = [];
...
assert(coveredProvinces.length === 23 && missingProvinces.length === 8, "Expected 23 covered and 8 missing provinces after Guizhou v3.296");
...
const report = {
  dataset: "official-control-line-coverage-2026-v3296",
