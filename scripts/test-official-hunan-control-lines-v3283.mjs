...
const modelVersion = "local-deterministic-v3.284-guangdong-control-lines2026-and-rank-provenance-846605records";
...
assert.equal(core.admissionScoreLayer.coverage.dataTypes["control-line"], 959);
