...
const modelVersion = "local-deterministic-v3.283-hunan-control-lines2026-and-boundary-routing-846556records";
...
assert.equal(core.admissionScoreLayer.coverage.dataTypes["control-line"], 910);
