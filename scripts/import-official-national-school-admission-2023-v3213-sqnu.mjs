...
const YEAR = 2023;
const DEFAULT_OUT = "data/admissions/official-national-school-admission-2023-v3213-sqnu-import.json";
const RAW_DIR = "data/admissions/raw/official-national-school-admission-2023-v3213-sqnu";
...
const PAGES = [
  {
    key: "outside-ordinary-sports-art-2023",
    title: "商丘师范学院2023年外省（普通本科，体育，艺术类本科）录取情况",
    url: `${BASE_URL}/info/1005/3374.htm`,
    rawBase: "2023-outside-ordinary-sports-art",
    parser: "outside",
  },
  {
    key: "henan-preparatory-directed-xizang-2023",
    title: "商丘师范学院2023年河南省预科及定向西藏生录取情况",
    url: `${BASE_URL}/info/1005/3373.htm`,
    rawBase: "2023-henan-preparatory-directed-xizang",
    parser: "henanUnrankedMajor",
  },
  {
    key: "henan-coop-joint-software-2023",
    title: "商丘师范学院2023年中外合作办学、联合办学及软件学院录取情况",
    url: `${BASE_URL}/info/1005/3372.htm`,
    rawBase: "2023-henan-coop-joint-software",
    parser: "henanUnrankedMajor",
  },
  {
    key: "henan-major-2023",
    title: "商丘师范学院2023年本科一批和二批各专业录取情况（6055）",
    url: `${BASE_URL}/info/1005/3371.htm`,
    rawBase: "2023-henan-major",
    parser: "henanUnrankedMajor",
  },
  {
    key: "henan-public-funded-teacher-2023",
    title: "商丘师范学院2023年公费师范生录取情况",
    url: `${BASE_URL}/info/1005/3370.htm`,
    rawBase: "2023-henan-public-funded-teacher",
    parser: "henanPublicTeacher",
  },
  {
    key: "henan-art-sports-2023",
    title: "商丘师范学院2023年河南省艺术及体育本科录取情况",
    url: `${BASE_URL}/info/1005/3369.htm`,
    rawBase: "2023-henan-art-sports",
    parser: "henanArtSports2023",
  },
  {
    key: "henan-upgrade-2023",
    title: "商丘师范学院2023年专升本录取情况",
    url: `${BASE_URL}/info/1005/3368.htm`,
    rawBase: "2023-henan-upgrade",
    parser: "henanUpgrade",
  },
];

const SOURCE = {
  id: "official-sqnu-national-2023-school-major-admission",
  quality: "official-school-sqnu-2023-national-pdf-score",
  schoolCode: "10483",
  schoolName: "商丘师范学院",
  city: "商丘",
...
const BATCH_RE = "(?:艺术第二批\\(统考本科批\\)\\(B段\\)|体育类第一批\\(统考本科批\\)|本科提前批艺术类本科第二批|艺术类本科批书法类|艺术类本科批播音与主持类|艺术类本科批美术与设计类|艺术类本科批舞蹈类|艺术类本科批音乐类|艺术类本科批统考|艺术体育统考本科批|艺术二批\\(B段\\)|体育艺术本一U段|本提前艺本二批|本科A电编类|本科A美术类|本科A音乐类|艺术本科B|艺术本科统考批|艺术类本科批|艺术本科2小批|艺术本科A段|艺术本科批|艺术专科批|提前批体育本科|体育类本科批|体育本科批|体育本科|本科提前批|提前批公费师范生|专升本批|普通本科批|普通类平行|本科第二批B类|本科一批|本科二批|本科批B段|本科批|专科批|普通类|常规批)";
const NUM_RE = "-?\\d+(?:\\.\\d+)?|-";
...
function usage() {
  return [
    "Usage:",
    `  node scripts/import-official-national-school-admission-2023-v3213-sqnu.mjs --out ${DEFAULT_OUT}`,
    "  node scripts/import-official-national-school-admission-2023-v3213-sqnu.mjs --use-cache",
    "",
    "Imports 商丘师范学院招生信息网 official 2023 PDF admission score tables.",
  ].join("\n");
}
...
function logicalOutsideLines(text) {
...
async function main() {
  ...
  const sourceNote = {
    id: SOURCE.id,
    title: "商丘师范学院招生信息网：2023年录取分数官方 PDF 表",
    publisher: "商丘师范学院招生信息网",
    url: INDEX_URL,
    quality: SOURCE.quality,
    usage: "从商丘师范学院招生信息网官方“录取分数”栏目下载 2023 年河南本科一批/二批、合作/联办/软件、预科/定向西藏、公费师范、河南艺体、河南专升本和外省普通/艺体本科 PDF 表，使用 pdftotext -layout 抽取单校分省分专业最高分、最低分、平均分、录取人数和省控线；源表未公开最低位次，运行层不生成假位次。学校官网单校数据不关闭任何省级正式投档/录取分数表缺口。",
    ...
    boundaryNotes: [
      ...
      "2023 年 PDF 源表未列最低分位次，运行层全部标记 rankUnavailable=true，不生成假位次。",
      "艺术、体育、公费师范、预科、定向西藏、专升本等按 special-path-only 隔离，不与普通高考文化分概率混算。",
    ],
  };
  ...
  const payload = {
    ...
    parserVersion: "v3213-sqnu-pdf-pdftotext-2023-01",
  };
