...
const DEFAULT_OUTPUT = "site/data/release-v3.275/admission-plan-supplement-v350.json.gz";
const INPUTS = [
...
function usage() {
  return `Usage:\n  node scripts/build-admission-plan-supplement-v350.mjs --out ${DEFAULT_OUTPUT}`;
}
...
function main() {
  ...
  const aggregateSource = {
    ...
    title: "官方院校 2026 分省分专业计划补充（苏州大学、暨南大学、茅台学院）",
    publisher: "苏州大学、暨南大学、茅台学院招生就业部",
    url: "https://www.mtxy.edu.cn/xzbm/zsjyc/zsxxw/zsjh/20260611/20260611_891712.shtml",
    quality: "official-school-national-plan-html-2026-multi-source",
    usage: "运行时独立补充层，汇总三所高校官网 2026 年分省分专业计划；只用于当年专业池、计划数、科类、选科和路径约束，不替代省级考试院计划、投档线或录取概率。",
  };
  const payload = {
    version: VERSION,
