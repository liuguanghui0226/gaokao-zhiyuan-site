...
const outFile = path.join(projectRoot, "data/admissions/official-control-line-coverage-2026-v3289.json");
const expectedCovered = ["安徽", "北京", "福建", "广东", "河南", "湖南", "江西", "吉林", "内蒙古", "陕西", "山东", "四川", "天津", "新疆", "西藏", "浙江"];
...
assert(coveredProvinces.length === 16 && missingProvinces.length === 15, "Expected 16 covered and 15 missing provinces after Fujian v3.289");
...
const report = {
  dataset: "official-control-line-coverage-2026-v3289",
