...
assert.equal(new Set(source.rawPaths).size, 33);
assert.ok(source.rawPaths.every((relativePath) => relativePath.startsWith("data/admissions/raw/official-national-school-plan-2026-v365-cust/")), "all evidence paths must stay under the CUST raw cache");
