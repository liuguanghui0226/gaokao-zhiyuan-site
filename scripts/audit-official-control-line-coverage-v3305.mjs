...
assert(manifest.modelVersion === modelVersion && core.modelVersion === modelVersion, "Unexpected v3.305 model version");
assert(manifest.recordCount === 847238, "Unexpected v3.305 record count");
