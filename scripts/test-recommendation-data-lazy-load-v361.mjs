...
assert.equal(state.planSupplementManifest.version, "v3.356+v3.358+v3.359+v3.360+v3.361");
assert.equal(state.planSupplementRecords.length, 5);
...
console.log(JSON.stringify({ status: "ok", bootCriticalFetches: 3, deferredFetches: 6, concurrentFetches: calls.length, retryableFailure: true }, null, 2));
