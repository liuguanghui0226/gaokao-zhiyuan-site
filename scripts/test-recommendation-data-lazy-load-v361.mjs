...
assert.match(app, /fetchRuntimeJson\("admission-plan-supplement-v367\.json", "官方计划补充"\)/);
...
const names = [
  ...
  "admission-plan-supplement-v367.json",
...
assert.equal(state.planSupplementManifest.version, "v3.356+v3.358+v3.359+v3.360+v3.361+v3.363+v3.365+v3.366+v3.367");
assert.equal(state.planSupplementRecords.length, 9);
...
console.log(JSON.stringify({ status: "ok", bootCriticalFetches: 3, deferredFetches: 10, concurrentFetches: calls.length, retryableFailure: true }, null, 2));
