...
const YEAR = 2021;
const DEFAULT_OUT = "data/admissions/official-national-school-admission-2021-v3215-sqnu-import.json";
const RAW_DIR = "data/admissions/raw/official-national-school-admission-2021-v3215-sqnu";
...
const PAGES = [
  {
    key: "outside-ordinary-sports-art-2021",
    title: "商丘师范学院2021年外省（普通本科，体育，艺术类本科）录取情况",
    url: `${BASE_URL}/info/1005/2811.htm`,
    rawBase: "2021-outside-ordinary-sports-art",
    parser: "outsideUnranked2021",
  },
  {
    key: "henan-coop-vocational-2021",
    title: "商丘师范学院2021年中外合作办学专科录取情况（6057）",
    url: `${BASE_URL}/info/1005/2809.htm`,
    rawBase: "2021-henan-coop-vocational",
    parser: "henanUnrankedMajorNoAvg",
  },
  {
    key: "henan-joint-sqvtc-2021",
    title: "商丘师范学院2021年与商丘职业技术学院联办录取情况（6058）",
    url: `${BASE_URL}/info/1005/2808.htm`,
    rawBase: "2021-henan-joint-sqvtc",
    parser: "henanRankedMajorNoCount",
  },
  {
    key: "henan-major-2021",
    title: "商丘师范学院2021年本科二批各专业录取情况（6055）",
    url: `${BASE_URL}/info/1005/2807.htm`,
    rawBase: "2021-henan-major",
    parser: "henanRankedMajorNoCount",
  },
  {
    key: "henan-coop-undergraduate-2021",
    title: "商丘师范学院2021年中外合作办学本科录取情况（6057）",
    url: `${BASE_URL}/info/1005/2806.htm`,
    rawBase: "2021-henan-coop-undergraduate",
    parser: "henanRankedMajorSeparatedRank2021",
  },
  {
    key: "henan-preparatory-2021",
    title: "商丘师范学院2021年河南省预科录取情况",
    url: `${BASE_URL}/info/1005/2805.htm`,
    rawBase: "2021-henan-preparatory",
    parser: "henanPreparatoryNoAvg",
  },
  {
    key: "henan-sports-2021",
    title: "商丘师范学院2021年河南省体育本科录取情况",
    url: `${BASE_URL}/info/1005/2803.htm`,
    rawBase: "2021-henan-sports",
    parser: "henanSportsMinOnly",
  },
  {
    key: "henan-upgrade-2021",
    title: "商丘师范学院2021年专升本录取情况",
    url: `${BASE_URL}/info/1005/2802.htm`,
    rawBase: "2021-henan-upgrade",
    parser: "henanUpgrade",
  },
  {
    key: "henan-art-2021",
    title: "商丘师范学院2021年河南艺术本科A段、B段及艺术专科录取情况",
    url: `${BASE_URL}/info/1005/2801.htm`,
    rawBase: "2021-henan-art",
    parser: "henanArtSports2023",
  },
  {
    key: "henan-public-funded-teacher-2021",
    title: "商丘师范学院2021年公费师范生录取情况",
    url: `${BASE_URL}/info/1005/2799.htm`,
    rawBase: "2021-henan-public-funded-teacher",
    parser: "henanPublicTeacher",
  },
];

const SOURCE = {
  id: "official-sqnu-national-2021-school-major-admission",
  quality: "official-school-sqnu-2021-national-pdf-score-rank",
  schoolCode: "10483",
  schoolName: "商丘师范学院",
  city: "商丘",
...
function usage() {
  return [
    "Usage:",
    `  node scripts/import-official-national-school-admission-2021-v3215-sqnu.mjs --out ${DEFAULT_OUT}`,
    "  node scripts/import-official-national-school-admission-2021-v3215-sqnu.mjs --use-cache",
    "",
    "Imports 商丘师范学院招生信息网 official 2021 PDF admission score tables.",
  ].join("\n");
}
...
async function main() {
  ...
  const sourceNote = {
    id: SOURCE.id,
    title: "商丘师范学院招生信息网：2021年录取分数官方 PDF 表",
    publisher: "商丘师范学院招生信息网",
    url: INDEX_URL,
    quality: SOURCE.quality,
    usage: "从商丘师范学院招生信息网官方“录取分数”栏目下载 2021 年河南本科二批、联办、中外合作本/专科、预科、公费师范、河南艺术体育、河南专升本和外省普通/艺体本科 PDF 表，使用 pdftotext -layout 抽取单校分省分专业最高分、最低分、平均分、录取人数、最低分位次或学校源表计分。学校官网单校数据不关闭任何省级正式投档/录取分数表缺口。",
    parsedRecords: records.length,
    ...
    boundaryNotes: [
      ...
      "2021 年部分河南本科/合作/联办表公开最低分位次；外省、合作专科、预科、艺体、公费师范和专升本表未列位次的行标记 rankUnavailable=true，不生成假位次。",
  ...
  const payload = {
    ...
    parserVersion: "v3215-sqnu-pdf-pdftotext-2021-01",
  };
