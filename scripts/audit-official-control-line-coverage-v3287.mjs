...
const outFile = path.join(projectRoot, "data/admissions/official-control-line-coverage-2026-v3287.json");
const expectedCovered = ["安徽", "北京", "广东", "河南", "湖南", "江西", "吉林", "陕西", "山东", "四川", "天津", "新疆", "西藏", "浙江"];
...
assert(coveredProvinces.length === 14 && missingProvinces.length === 17, "Expected 14 covered and 17 missing provinces after Tianjin v3.287");
...
const report = {
  dataset: "official-control-line-coverage-2026-v3287",
