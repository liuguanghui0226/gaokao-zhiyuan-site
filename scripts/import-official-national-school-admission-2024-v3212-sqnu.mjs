...
const YEAR = 2024;
const DEFAULT_OUT = "data/admissions/official-national-school-admission-2024-v3212-sqnu-import.json";
const RAW_DIR = "data/admissions/raw/official-national-school-admission-2024-v3212-sqnu";
...
const PAGES = [
  {
    key: "henan-major-2024",
    title: "商丘师范学院2024年本科批各专业录取情况",
    url: `${BASE_URL}/info/1005/3458.htm`,
    rawBase: "2024-henan-major",
    parser: "henanRankedMajor",
  },
  {
    key: "henan-coop-joint-software-art-single-2024",
    title: "商丘师范学院2024年中外合作办学、联合办学、软件学院及艺术单列专业录取情况",
    url: `${BASE_URL}/info/1005/3459.htm`,
    rawBase: "2024-henan-coop-joint-software-art-single",
    parser: "henanRankedMajor",
  },
  {
    key: "henan-preparatory-directed-xizang-2024",
    title: "商丘师范学院2024年河南省预科及定向西藏生录取情况",
    url: `${BASE_URL}/info/1005/3460.htm`,
    rawBase: "2024-henan-preparatory-directed-xizang",
    parser: "henanPreparatoryDirected",
  },
  {
    key: "outside-ordinary-sports-art-2024",
    title: "商丘师范学院2024年外省（普通本科，体育，艺术类本科）录取情况",
    url: `${BASE_URL}/info/1005/3461.htm`,
    rawBase: "2024-outside-ordinary-sports-art",
    parser: "outside",
  },
  {
    key: "henan-public-funded-teacher-2024",
    title: "商丘师范学院2024年公费师范生录取情况",
    url: `${BASE_URL}/info/1005/3457.htm`,
    rawBase: "2024-henan-public-funded-teacher",
    parser: "henanPublicTeacher",
  },
  {
    key: "henan-art-sports-2024",
    title: "商丘师范学院2024年河南省艺术及体育本科录取情况",
    url: `${BASE_URL}/info/1005/3456.htm`,
    rawBase: "2024-henan-art-sports",
    parser: "henanArtSports",
  },
];

const SOURCE = {
  id: "official-sqnu-national-2024-school-major-admission",
  quality: "official-school-sqnu-2024-national-pdf-score-rank",
  schoolCode: "10483",
  schoolName: "商丘师范学院",
  city: "商丘",
...
const SUBJECT_RE = "(?:综合改革|普通类|历史类|物理类|文史|理工|文科综合|理科综合|艺术类|体育类|书法类统考|书法类|播音与主持类统考|播音与主持类|美术与设计类统考|美术与设计类|舞蹈类统考|舞蹈类|音乐表演类（器乐）统考|音乐表演类（声乐）统考|体育（历史科目组合）|体育（物理科目组合）|体育\\(不分科目类\\)|体育（不分科目类）|艺术（不分文理）|艺术\\(历史类\\)|艺术\\(不分科目类\\)|体育类（历史等科目类）|器乐（历史等科目类）|美术与设计（历史等科目类）|体育类（历史科目组）|体育类（不分历史物理）|艺术类（不分历史物理）)";
const BATCH_RE = "(?:艺术第二批\\(统考本科批\\)\\(B段\\)|体育类第一批\\(统考本科批\\)|本科提前批艺术类本科第二批|艺术类本科批书法类|艺术类本科批播音与主持类|艺术类本科批美术与设计类|艺术类本科批舞蹈类|艺术类本科批音乐类|艺术类本科批统考|艺术体育统考本科批|艺术本科统考批|艺术类本科批|艺术本科2小批|艺术本科批|艺术专科批|提前批体育本科|体育类本科批|体育本科批|体育本科|本科提前批|提前批公费师范生|普通本科批|普通类平行|本科第二批B类|本科一批|本科二批|本科批B段|本科批|专科批|普通类|常规批)";
const NUM_RE = "-?\\d+(?:\\.\\d+)?|-";
...
function usage() {
  return [
    "Usage:",
    `  node scripts/import-official-national-school-admission-2024-v3212-sqnu.mjs --out ${DEFAULT_OUT}`,
    "  node scripts/import-official-national-school-admission-2024-v3212-sqnu.mjs --use-cache",
    "",
    "Imports 商丘师范学院招生信息网 official 2024 PDF admission score tables.",
  ].join("\n");
}
...
async function main() {
  ...
  const sourceNote = {
    id: SOURCE.id,
    title: "商丘师范学院招生信息网：2024年录取分数官方 PDF 表",
    publisher: "商丘师范学院招生信息网",
    url: INDEX_URL,
    quality: SOURCE.quality,
    usage: "从商丘师范学院招生信息网官方“录取分数”栏目下载 2024 年河南普通本科、合作/联办/软件/编导、预科/定向西藏、公费师范、河南艺体和外省普通/艺体本科 PDF 表，使用 pdftotext -layout 抽取单校分省分专业最高分、最低分、平均分、录取人数、最低位次或省控线。学校官网单校数据不关闭任何省级正式投档/录取分数表缺口。",
    ...
    boundaryNotes: [
      ...
      "河南省预科、定向西藏生记录是河南考生特殊路径，不是西藏自治区省级投档表，不能关闭西藏正式省级缺口。",
      "外省 PDF 多数未列最低分位次，运行层标记 rankUnavailable=true，不生成假位次。",
      "艺术、体育、公费师范、预科、定向西藏等按 special-path-only 隔离，不与普通高考文化分概率混算。",
    ],
  };
  ...
  const payload = {
    ...
    parserVersion: "v3212-sqnu-pdf-pdftotext-2024-01",
  };
