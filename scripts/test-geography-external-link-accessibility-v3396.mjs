...
const instrumented = `${appSource.slice(0, bootIndex)}\nglobalThis.__geographyTest = { renderSource, renderSourceDirectory, state };`;
...
const directory = api.renderSourceDirectory({ sources: [externalSource] });
