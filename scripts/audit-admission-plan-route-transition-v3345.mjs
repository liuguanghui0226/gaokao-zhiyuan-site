...
const shardFiles = fs.readdirSync(releaseDir)
  ...
  .filter((file) => ![
    ...
    "admission-plan-supplement-v348.json.gz",
    "admission-plan-supplement-v349.json.gz",
    ...
    "admission-plan-supplement-v354.json.gz",
    "admission-plan-supplement-v355.json.gz",
    "admission-plan-supplement-v356.json.gz",
    "admission-plan-supplement-v358.json.gz",
    "admission-plan-supplement-v359.json.gz",
    ...
    "admission-plan-supplement-v367.json.gz",
