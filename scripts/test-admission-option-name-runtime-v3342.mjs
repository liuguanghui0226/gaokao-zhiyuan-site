...
const liteAudit = readJson("runtime-core-lite-v3342-manifest.json");
...
assert.equal(core.generatedAt, "2026-07-30T05:30:00+08:00");
assert.equal(manifest.generatedAt, "2026-07-30T05:30:00+08:00");
