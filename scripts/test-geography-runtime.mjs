...
assert.equal(site.version, "geo-2026.08.23.31");
assert.equal(site.sources.length, 213);
assert.equal(site.items.length, 485);
assert.equal(site.sources.filter((sourceRecord) => /^https:\/\//.test(String(sourceRecord.url))).length, 191);
