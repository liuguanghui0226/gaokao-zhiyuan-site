...
assert.equal(site.version, "geo-2026.08.23.32");
assert.equal(site.sources.length, 216);
assert.equal(site.items.length, 500);
assert.equal(site.sources.filter((sourceRecord) => /^https:\/\//.test(String(sourceRecord.url))).length, 194);
