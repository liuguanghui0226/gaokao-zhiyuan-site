...
assert.equal(site.version, "geo-2026.08.23.30");
assert.equal(site.sources.length, 206);
assert.equal(site.items.length, 470);
assert.equal(site.sources.filter((sourceRecord) => /^https:\/\//.test(String(sourceRecord.url))).length, 184);
