...
const expectedVersion = "local-deterministic-v3.339-route-isolated-official-first-trends-868426records";
...
assert.equal(core.generatedAt, "2026-07-30T03:35:00+08:00");
assert.equal(manifest.generatedAt, "2026-07-30T03:35:00+08:00");
