...
assert.deepEqual([year2025.sources, year2025.parsedSources, year2025.parsedRecords], [78, 54, 22360]);
...
console.log(JSON.stringify({ ok: true, modelVersion, ranks: 398, linkedAdmissionRecords: 7060, belowPublishedFloor: 1496, specialPathExcluded: 123, sourceNotes: 5126 }, null, 2));
