...
assert.deepEqual([year2025.sources, year2025.parsedSources, year2025.parsedRecords], [80, 56, 24383]);
...
console.log(JSON.stringify({ ok: true, modelVersion, ranks: 398, linkedAdmissionRecords: 7060, belowPublishedFloor: 1496, specialPathExcluded: 123, sourceNotes: 5128 }, null, 2));
