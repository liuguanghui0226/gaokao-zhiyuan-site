...
assert.equal(Object.values(manifest.shards).reduce((sum, item) => sum + item.records, 0), 867350);
...
assert.equal(totalRecords, 867350);
...
assert.equal(manifest.shards["新疆"].records, 10442);
...
assert.equal(provinceCoverage.records, 10442);
assert.equal(provinceCoverage.dataTypes["institution-admission"], 2036);
assert.equal(readiness.records, 10442);
assert.equal(readiness.institutionRecords, 2036);
assert.equal(readiness.rankConversionRecords, 2823);
assert.equal(year2025.records, 397758);
assert.equal(year2025.dataTypes["institution-admission"], 22107);
