...
v3.307 当前运行版本为 `local-deterministic-v3.307-national-school-official-jxust2023-2025-native-rank-855003records`，含 855003 条结构化录取/投档/计划/资格边界、116656 条位次换算记录和 5112 条来源说明。新增江西理工大学 2023-2025 年全国 31 省单校分专业记录 2905 条；2704 条官网表列最低分位次保存为 `school-recorded-min-score-rank`，201 条未公布位次的行保持 `rankUnavailable=true`。这与 v3.306 南昌航空大学 4804 条 `score-derived-provincial-segment` 换算位次严格分开：前者是学校表格直接记录的最低分位次，后者由最低分和省一分一段表换算；两者都只是单校边界，不等于省级全量投档表或录取概率。普通 2596 条为 `school-official-only`，艺体、专项、预科、定向、征集和合作办学等 309 条为 `special-path-only`。
