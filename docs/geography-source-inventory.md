...
盘点日期：2026-08-23；扩展轮次：geo-2026.08.23.19

本清单服务于 `data/geography/knowledge.json`。公开站点只发布原创学习摘要、关键词、课程归属和可回到教材核对的页码证据，不复制教材正文、插图、版式或整章内容。

当前发布版本 `geo-2026.08.23.19`：136 个来源、305 条卡片，其中 38 条 `authored-summary`、267 条 `citation-only`；五个课程族分别为 52、62、67、60、64 条。本轮新增 5 个中国官方公开来源、2 个 GitHub 来源与 15 条原创 `citation-only` 方法卡，覆盖天地图图层与比例尺、国家统计指标、地震目录、森林生态治理、全球环流模型、太阳高度角与地方时。
