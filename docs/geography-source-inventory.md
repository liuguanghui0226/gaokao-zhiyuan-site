...
盘点日期：2026-08-23；扩展轮次：geo-2026.08.23.20

本清单服务于 `data/geography/knowledge.json`。公开站点只发布原创学习摘要、关键词、课程归属和可回到教材核对的页码证据，不复制教材正文、插图、版式或整章内容。

当前发布版本 `geo-2026.08.23.20`：144 个来源、320 条卡片，其中 38 条 `authored-summary`、282 条 `citation-only`；五个课程族分别为 55、65、70、63、67 条。本轮新增 6 个中国及国际官方公开来源、1 个 GitHub 来源、1 份本地试卷与 15 条原创 `citation-only` 方法卡，覆盖冻土水循环、沙尘天气观测、地质公园实践、资源型城镇转型、农业农村发展、上升流与 Walker 环流、日地月观测、气象数据选源、环境监测、自然资源规划、粮食安全与气候风险治理。
